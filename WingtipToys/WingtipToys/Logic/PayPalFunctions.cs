...
public class NVPAPICaller
{
    ...
    public string APIUsername = "daniel.melero.95-facilitator_api1.gmail.com";
    private string APIPassword = "SQMW87Q5CF5ZD8LY";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AFG2Je-cOB-xBF-f4UZDEXppzOVG";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:61434/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:61434/Checkout/CheckoutCancel.aspx";
